...
CREATE TABLE elenco_filme (
    ...
    CONSTRAINT fk_elenco_filme FOREIGN KEY (id_filme) REFERENCES filmes(id)
);
...
-- Ajustar a sequência para a tabela atores
SELECT setval('atores_id_seq', (SELECT MAX(id) FROM atores));
...
-- Ajustar a sequência para a tabela filmes
SELECT setval('filmes_id_seq', (SELECT MAX(id) FROM filmes));
...
-- Ajustar a sequência para a tabela generos
SELECT setval('generos_id_seq', (SELECT MAX(id) FROM generos));
...
-- Ajustar a sequência para a tabela elenco_filme
SELECT setval('elenco_filme_id_seq', (SELECT MAX(id) FROM elenco_filme));
...
-- Ajustar a sequência para a tabela filmes_genero
SELECT setval('filmes_genero_id_seq', (SELECT MAX(id) FROM filmes_genero));